...
<body>
    ...
    <main id="main">
            <?php 
                ...
                $query="SELECT * FROM specification WHERE products_brand='Apple'";
                    $result=$db->query($query);
                    echo "<p class='brand'><a href='../index.php'>Početna strana</a> / Akcija</p>"; 
                    echo "<h2>Akcija</h2>";
                    ...
                    while($row=$db->fetch_object($result)) 
                    {
                            ...
                            echo "<p class='viewMore'><a href='productinfo.php?kategorija=$row->category&sifraProizvoda=$row->specification_id'>Saznajte više&nbsp;&raquo;</a></p>";
                            echo "</div>";
